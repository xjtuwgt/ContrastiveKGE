...
class ArgParser(CommonArgParser):
    def __init__(self):
        ...
        self.add_argument('--graph_batch_size', type=int, default=1, help='batch size for contrastive learning')
        self.add_argument('--dev_graph_batch_size', type=int, default=1, help='batch size for contrastive learning')
        self.add_argument('--cpu_num', type=int, default=1, help='number of cpus for data loader')
